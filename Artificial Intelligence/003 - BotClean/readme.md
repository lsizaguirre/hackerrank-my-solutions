...
Complete the function _next_move_ that takes in 3 parameters _posr_, _posc_ being the co-ordinates of the bot's current position and _board_ which indicates the board state to print the bot's next move.

The codechecker will keep calling the function _next_move_ till the game is over or you make an invalid move.
